...
<head>
    ...
    <title>Dashboard/Profesoret</title>
</head>
<body>
        ...
        <div class="headertwo">
                ...
                <ul>
                    ...
                    <li style="background-color:rgb(219, 145, 145); "><a href="../dashboard/profesoret.php" style="color:whitesmoke;">Profesorët</a></li>
        ...
        <?php
        $query = mysqli_query($connect, "SELECT * FROM perdoruesi WHERE roli = 'profesor';");
    ...
    ?>
        ...
        <div class="main"  style="overflow-x:auto;">
            ...
            <table class="tabela">
                <tr>
                    <th>Informata te Profesorit</th>
                    <th>Username</th>
                    <th></th>
                </tr>
                <?php
                        $query1 = mysqli_query($connect, "SELECT * FROM perdoruesi WHERE roli = 'profesor';");                  
                    ...
                    while($fetch1 = mysqli_fetch_assoc($query1)){
                        ...
                        <td>
                            ...
                            <a href='../dashboard/ndryshoStudent.php?id=$IDd'><i class='bi bi-arrow-repeat'></i> Ndrysho</a>
                                <a href='../dashboard/fshijP.php?id=$IDd'><i class='bi bi-trash3'></i> Fshij</a>
                            </div>
                        </td>
                    </tr>";
                    }
